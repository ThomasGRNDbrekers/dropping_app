...
# PLAK HIER JE SLEUTEL: Zorg dat er GEEN spaties voor of na de regels staan.
...
# We herstellen de sleutel door handmatig enters toe te voegen aan het begin en eind
# en alle ongewenste spaties te verwijderen.
CLEAN_PRIVATE_KEY = RAW_KEY_DATA.strip()
...
try:
    ...
    st.info("Tip: Controleer of je de volledige Private Key hebt geplakt inclusief de BEGIN en END regels.")
    st.stop()
...
if not st.session_state.logged_in:
    ...
    if st.session_state.role == "admin":
        ...
        if my_data['Fase'] == "START":
            ...
            st.metric("Afstand tot Finish", "Verbinding OK! GPS wordt geladen...")
